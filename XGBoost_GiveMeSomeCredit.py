"""
credit_scoring_give_me_some_credit.py
Give Me Some Credit (cs-training.csv)
Usage:
  1) Put cs-training.csv next to this script.
  2) pip install pandas numpy scikit-learn xgboost matplotlib seaborn joblib shap
  3) python credit_scoring_give_me_some_credit.py
"""
...
multiprocessing.set_start_method("fork", force=True)  # for macOS compatibility
import numpy as np
import pandas as pd
...
# -----------------------
SEED = 42
DATA_FILE = "cs-training.csv"   # put file here
